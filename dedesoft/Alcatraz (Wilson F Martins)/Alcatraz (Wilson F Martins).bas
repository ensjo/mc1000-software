...
341 Q =  ASC (I$)
350  GOSUB 1390
360  IF (Q > 64 AND Q < 91) OR Q = 32 THEN FR$ = "":I = 0: SET 2,1: GOTO 980
370 MO = 0
...
915  IF  USR (A) INPUT  <  > "" THEN 915
920 I$ =  USR (A) INPUT : IF I$ = "" THEN 920
925 Q =  ASC (I$)
930  IF (Q < 65 OR Q > 90) AND Q <  > 32 THEN 960
940  SET I + 2,1:A =  USR (I$) PRINT  =  USR (S$) PRINT :FR$ = FR$ + I$:I = I + 1: IF I <  > 30 THEN 915
950  GOTO 1010
960  IF Q = 127 THEN  IF I THEN I = I - 1:FR$ =  LEFT$ (FR$,I): SET I + 2,1:A =  USR (S$ + "  ") PRINT : GOTO 915
...
65010  TEXT : HOME : POKE 836,0: PRINT "INSTALANDO ROTINAS USR. AGUARDE."
65020  RESTORE 65100
65030  READ E: IF E =  - 1 THEN  RESTORE : RETURN 
65040  READ B: IF B =  - 1 THEN 65030
65050  POKE E,B:E = E + 1: GOTO 65040
65100  REM CONFIGURA USR()
65110  DATA 771
65120  DATA 195,234,187,-1
65130  REM PACOTE DE ROTINAS USR
65140  DATA 48106
65150  DATA 225,227,126,254,133,194,96,188,205,160,221,254,138,40,35,254,144,55,40,30,227,58,31,1,183,32,8,33,144,3,54,1,195,29,229,62,1,205,230,230,58,27,1,42,164,3,119,195,20,231,229,33,32,1,17,47,188,1,50,188,205,92,189,225,205,160,221,227,233,,,,195,53
65160  DATA 188,33,14,,57,126,254,93,192,35,126,254,221,192,33,8,,57,54,76,35,54,188,201,193,209,51,51,50,31,1,183,58,27,1,50,28,1,196,223,221,195,97,221,254,153,32,65,205,160,221,254,138,40,32,254,144,55,40,27,205,156,233,213,205,17,220,40,205,153,233,209
65170  DATA 87,205,17,220,41,243,123,211,32,122,211,96,251,227,233,229,33,56,,17,160,188,1,163,188,243,205,92,189,251,225,205,160,221,227,233,,,,237,77,254,151,194,89,189,205,160,221,254,220,202,78,189,227,229,205,161,232,200,71,35,35,78,35,102,105,237,91,89
65180  DATA 3,122,83,95,205,134,200,126,35,254,10,32,6,30,32,205,18,189,175,214,32,56,47,79,205,18,189,121,229,213,197,33,,128,25,235,38,,111,41,41,41,1,119,189,9,58,82,3,214,1,159,47,79,6,8,126,169,18,35,123,198,32,95,16,246,193,209,225,19,16,191,99,106,34
