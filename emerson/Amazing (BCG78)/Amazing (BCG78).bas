0 HOME
10 INVERSE : PRINT TAB( 7);"PROGRAMA 'AMAZING'"; TAB( 32);: NORMAL : PRINT TAB( 37);"(GERADOR DE LABIRINTOS)": PRINT
20 PRINT TAB( 7);"CREATIVE COMPUTING"; TAB( 37);"MORRISTOWN, NEW JERSEY"
30 PRINT : PRINT : PRINT : PRINT
100 INPUT "FORNECA AS DIMENSOES DO LABIRIN-TO (LARGURA E ALTURA) SEPARADAS POR VIRGULA";H,V
102 IF H < > 1 AND V < > 1 THEN 110
104 PRINT "NENHUMA DIMENSAO PODE SER IGUAL A 1. TENTE DE NOVO.": GOTO 100
110 DIM W(H,V),V(H,V)
120 PRINT
130 PRINT
140 PRINT
