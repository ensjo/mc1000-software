...
7  PRINT  TAB( 7);"CREATIVE COMPUTING"
9  PRINT  TAB( 5);"MORRISTOWN, NEW JERSEY"
10  DATA 0
...
35  GOSUB 500
40  PRINT "SUA JOGADA";: GOSUB 110
45  IF E = 0 THEN 80
50  IF M = H THEN  GOSUB 100
55  IF E = 0 THEN 80
60  PRINT "MINHA JOGADA E ";: GOSUB 800
65  IF E = 0 THEN 80
70  IF M = H THEN  PRINT ",";: GOSUB 800
75  IF E > 0 THEN 35
80  PRINT : PRINT "FIM DE JOGO."
85 D = B(6) - B(13): IF D < 0 THEN  PRINT "EU VENCI POR"; - D;"PONTOS.": GOTO 20
90 N = N + 1: IF D = 0 THEN  PRINT "EMPATE.": GOTO 20
95  PRINT "VOCE VENCEU POR";D;"PONTOS.": GOTO 20
100  PRINT "DE NOVO";
110  INPUT M: IF M < 7 THEN  IF M > 0 THEN M = M - 1: GOTO 130
120  PRINT "JOGADA ILEGAL": GOTO 100
