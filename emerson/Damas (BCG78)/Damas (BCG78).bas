5  PRINT  TAB( 13);"DAMAS"
10  PRINT  TAB( 7);"CREATIVE COMPUTING": PRINT  TAB( 5);"MORRISTOWN, NEW JERSEY"
15  PRINT : PRINT : PRINT 
20  PRINT "ESTE E O JOGO DE DAMAS. O COMPU-";: PRINT "TADOR E 'X', VOCE E 'O'."
25  PRINT "O COMPUTADOR JOGA PRIMEIRO."
30  PRINT "AS CASAS SAO REFERENCIADAS POR": PRINT "UM SISTEMA DE COORDENADAS:"
35  PRINT "0,0 = CANTO INFERIOR ESQUERDO."
40  PRINT "0,7 = CANTO SUPERIOR ESQUERDO."
45  PRINT "7,0 = CANTO INFERIOR DIREITO."
50  PRINT "7,7 = CANTO SUPERIOR DIREITO."
51  INPUT "<ENTER> PARA CONTINUAR";X$
55  PRINT "O COMPUTADOR ESCREVERA 'PARA'": PRINT "SE VOCE TIVER OUTRO SALTO."
60  PRINT "DIGITE DOIS NUMEROS NEGATIVOS SE";: PRINT "VOCE NAO PUDER SALTAR."
...
1230  PRINT "DE";R(1);R(2);"PARA";R(3);R(4);:R(0) =  - 99
...
1360  NEXT A: IF R(0) <  >  - 99 THEN  PRINT "PARA";R(3);R(4);:R(0) =  - 99: GOTO 1240
1365  GOTO 1420
1370 U = X + A:V = Y + B: IF U < 0 OR U > 7 OR V < 0 OR V > 7 THEN 1400
1380  IF S(U,V) = 0 AND S(X + A / 2,Y + B / 2) > 0 THEN  GOSUB 910
1400  RETURN 
1420  PRINT : PRINT : PRINT : FOR Y = 7 TO 0 STEP  - 1: FOR X = 0 TO 7: IF X THEN  PRINT  TAB( X * 3);
...
1550  NEXT X: PRINT " ": NEXT Y: PRINT 
1552  FOR L = 0 TO 7
1554  FOR M = 0 TO 7
