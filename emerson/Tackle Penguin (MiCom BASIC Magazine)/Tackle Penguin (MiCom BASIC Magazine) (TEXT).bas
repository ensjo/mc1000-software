...
2510  POKE 910,0: PRINT AT$; CHR$ (Y0 + J); CHR$ (X0 + I + 32);M$(K);: RETURN 
2600  REM *MOVE PINGUIM
2610  POKE 910,0: PRINT AT$; CHR$ (Y0 + Y); CHR$ (X0 + X + 32);E$;AT$; CHR$ (Y0 + YT); CHR$ (X0 + XT + 32);P$;: RETURN 
2700  REM *MOVE BLOCO
...
3300  REM *APAGA MAPA
3310  FOR J = 0 TO MY - 1: POKE 910,0: PRINT AT$; CHR$ (Y0 + J); CHR$ (X0 + 32);M2$;: NEXT J: RETURN 
3400  REM *MOSTRA NUMERO DA FASE
3410  POKE 910,0: PRINT AT$; CHR$ (14); CHR$ (6 + 32); RIGHT$ (" " +  STR$ (F),2);: RETURN 
4000  REM JOGO
...
4110  PRINT AT$; CHR$ (14); CHR$ (26 + (5 - V) + 32);P$;: RETURN 
4200  REM *TELA TITULO
4210  TEXT : HOME 
4220  PRINT AT$; CHR$ (1); CHR$ (10 + 32);: INVERSE : PRINT " T A C K L E ";: NORMAL 
4230  PRINT AT$; CHR$ (3); CHR$ (9 + 32);: INVERSE : PRINT " P E N G U I N ";: NORMAL 
4240  PRINT AT$; CHR$ (6); CHR$ (5 + 32);P$;" ..... TACKLE PENGUIN";
4250  PRINT AT$; CHR$ (8); CHR$ (5 + 32);C$;" ..... CHAVE";
4260  PRINT AT$; CHR$ (10); CHR$ (5 + 32);B$;" ..... BLOCO";
4270  PRINT AT$; CHR$ (14); CHR$ (8 + 32);"[QUALQUER TECLA]";
4280  CALL 49158: RETURN 
4300  REM *TELA DE JOGO
4310  HOME : POKE 304,201: POKE 247,202: POKE 248,192: POKE 249,202: POKE 250,192: CALL 52013: REM CURSOR INVISIVEL
4320  INVERSE : PRINT "         TACKLE PENGUIN         ";: NORMAL 
4330  FOR J =  - 1 TO MY: POKE 910,0: PRINT AT$; CHR$ (Y0 + J); CHR$ (X0 - 1 + 32);M1$;: NEXT J
4340  FOR J = 14 TO 15: POKE 910,0: PRINT AT$; CHR$ (J); CHR$ (32); SPC( 31);: NEXT J
4350  POKE 910,0: PRINT AT$; CHR$ (14); CHR$ (0 + 32);"FASE:";
4360  PRINT AT$; CHR$ (14); CHR$ (16 + 32);"REINICIOS:";
4370  PRINT AT$; CHR$ (15); CHR$ (0 + 32);" MIDORINOTANUKI / EMERSON COSTA";
4380  RETURN 
4400  REM FIM DE JOGO SEM VIDAS
4410  PRINT AT$; CHR$ (8); CHR$ (11 + 32);: INVERSE : PRINT "FIM DE JOGO";: NORMAL 
...
4440  CALL 49158: RETURN 
4500  REM FIM DE JOGO COMPLETO
4510  PRINT AT$; CHR$ (8); CHR$ (11 + 32);: INVERSE : PRINT "PARABENS!!";: NORMAL 
...
11040 AT$ =  CHR$ (27) + "=": REM SEQUENCIA DE ESCAPE PARA POSICIONAR CURSOR
11050 P$ = "A": REM SPRITE DO PINGUIM
11060 C$ = "F": REM SPRITE DA CHAVE
11070 E$ = " ": REM SPRITE DO ESPACO
11080 B$ =  CHR$ ( ASC ("=") + 128): REM SPRITE DO BLOCO
...
11110  DIM M$(3):M$(0) = E$:M$(1) = B$:M$(2) = C$:M$(3) = P$: REM MATRIZ PARA TRADUZIR VALORES DO MAPA EM SPRITES
11120  TEMPO 255,2,1: TEMPO 255,2,2: RETURN 
64999  END 
65000  REM INSTALADOR
65001  TEXT : HOME : PRINT "POKEANDO. AGUARDE..."
65002  RESTORE 65000
65003  READ E: PRINT E;: IF E =  - 1 THEN  RETURN 
65004  READ B: PRINT ".";: IF B =  - 1 THEN  PRINT : GOTO 65003
65005  POKE E,B:E = E + 1: GOTO 65004
65010  REM ROTINA DE FLUIDEZ DE TECLADO
65011  DATA 59
65012  DATA 33,14,,57,126,254,93,192,35,126,254,221,192,33,8,,57,17,83,,115,35,114,201,193,209,51,51,50,29,1,183,58,27,1,50,28,1,196,223,221,195,97,221,-1
65013  DATA 289
65014  DATA 59,,-1
65015  DATA 288
65016  DATA 195,-1
